...
public class UserControllerTest {
	...
	public void setup() {
		...
		this.validUser = new User("04303145076", "João Pedro", "jpedross1999@gmail.com", "12345678", false, this.address, "984401159");
    ...
    public void createInvalidUserWithoutName() throws Exception {
		User invalidUserWithName = new User("04303145076", null, "jpedross1999@gmail.com", "12345678", false, this.address,"984401159");
    ...
    public void createInvalidUserWithNothingExceptName() throws Exception {
		User invalidUserWithNothing = new User(null, "Eduardo Barbosa Viegas", null,null,null, this.address,"984401159");
		mockMvc.perform(post("/user/register/").with(user("user").password("123456789"))
        		.contentType(IntegrationTestUtil.APPLICATION_JSON_UTF8)
    ...
    public void createInvalidUserWithInvalidCPF() throws Exception {
		User userWithInvalidCPF = new User("04103145076", "João Pedro", "jpedross1999@gmail.com", "12345678", false, this.address,"984401159");
		mockMvc.perform(post("/user/register/").with(user("user").password("123456789"))
        		.contentType(IntegrationTestUtil.APPLICATION_JSON_UTF8)
    ...
    public void createInvalidUserWithInvalidEmail() throws Exception {
		User userWithInvalidEmail = new User("04303145076", "Eduardo Barbosa Viegas", "eduardo@", "12345678", false, this.address,"984401159");
		mockMvc.perform(post("/user/register/").with(user("user").password("123456789"))
        		.contentType(IntegrationTestUtil.APPLICATION_JSON_UTF8)
    ...
    public void createInvalidUserWithInvalidPassword() throws Exception {
		User userWithInvalidPassword = new User("04303145076", "João Pedro", "jpedross1999@gmail.com", "123", false, this.address,"984401159");
		mockMvc.perform(post("/user/register/").with(user("user").password("123456789"))
        		.contentType(IntegrationTestUtil.APPLICATION_JSON_UTF8)
    ...
    public void createInvalidUserWithoutAddress() throws Exception {
		User userWithInvalidPassword = new User("04303145076", "João Pedro", "jpedross1999@gmail.com", "123", false, null,"984401159");
		mockMvc.perform(post("/user/register/").with(user("user").password("123456789"))
        		.contentType(IntegrationTestUtil.APPLICATION_JSON_UTF8)
        		.content(IntegrationTestUtil.convertObjectToJsonBytes(userWithInvalidPassword))
        	)
