INSERT INTO country (country_id, insertion_date,name) values (1, current_date, 'Brasil');
INSERT INTO address_state(state_id,name, abbreviation, country_id) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
Update address_state set insertion_date = current_date;
...
Update city set insertion_date = current_date;

Select * From city where state_id = 23;
